...
\item Understand the principles and applications of transmission lines, including twisted pairs, coaxial  cables, and waveguides.
\item Comprehend the advantages and disadvantages of each type of transmission line in terms of signal quality, bandwidth, and attenuation.
\item Gain knowledge about the practical considerations for selecting and installing antennas and transmission lines in various communication systems.
\item Discuss Cellular communication and how it is related to transmission line.
\item Understand the principle and application of cellular communication, radar and remote sensing radio astronomy and EMI/EMC. 
\item Develop practical skills on analyzing and trouble shooting these system.
\item Learn about Azimuth resolution and what it is defined by.
\end{enumerate}
\end{mdframed}
...
\begin{ExerciseList}
	...
	\Exercise[label={ex17}]
	What is the basic working principle of the antenna?
	
	\Exercise[label={ex18}]
	How does the size of an antenna affect its performance?
	
	\Exercise[label={ex19}]
	what are the benefit of using adaptive arrays over switched beams in wireless communication?
