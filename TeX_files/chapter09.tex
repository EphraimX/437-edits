...
\begin{figure}[h]
\centering
\includegraphics[width=0.8\linewidth]{graphics/Group93}
\caption{Standing wave pattern variation of a complex inductive load}
\label{fig:group93}
\end{figure}
\begin{figure}[h]
\centering
\includegraphics[width=0.8\linewidth]{graphics/Group94}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.8\linewidth]{graphics/Group96}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.8\linewidth]{graphics/Group97}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.8\linewidth]{graphics/Group95}
